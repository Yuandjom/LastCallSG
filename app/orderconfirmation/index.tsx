  ...
  return (
    <View style={styles.container}>
      <View style={styles.contentContainer}>
        ...
        <Text style={styles.message}>We have choped your order!</Text>
        ...
        <View style={styles.orderContainer}>
          ...
          <View style={styles.orderDetails}>
            ...
            <Text style={styles.value}>{truncateText(orderId, 20)}</Text>
          </View>
          <View style={styles.orderDetails}>
          ...
          <View style={styles.orderDetails}>
            ...
            <Text style={styles.value}>S${item.finalPrice}</Text>
          </View>
          <View style={styles.orderDetails}>
            <Text style={styles.totallabel}>Total:</Text>
            <Text style={styles.totalValue}>S${totalPrice}</Text>
          </View>
        </View>
